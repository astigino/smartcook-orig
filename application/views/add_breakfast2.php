<div class="header" id="content">
    <div class="container">
        <h1><i class="fa fa-th-large"></i> Add Breakfast</h1>
        <p>Chief Cook's Recommendation, Add Breakfast</p>
    </div>
</div>
                ...
                <div class="col-xs-2">
                    <div class="thumbnail">
                        ...
                        <div class="caption ">
                            ...
                            <p><a class="btn btn-warning btn-xs" href="<?php echo base_url('site/update_30daymenu'); ?>/<?php echo $recipe_plan_id; ?>/<?php echo $plan_id; ?>/<?php echo $row_recipes_list->id; ?>/2" role="button" rel="tooltip" title="Add Breakfast">Add Breakfast</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
