                ...
                <div class="col-xs-2">
                    <div class="thumbnail">
                        ...
                        <div class="caption ">
                            ...
                            <p><a class="btn btn-primary btn-xs" href="<?php echo base_url('site/update_30daymenu'); ?>/<?php echo $recipe_plan_id; ?>/<?php echo $plan_id; ?>/<?php echo $row_recipes_list->id; ?>/3" role="button" rel="tooltip" title="Add Lunch">Add Lunch</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
